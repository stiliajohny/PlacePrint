...
const DEFAULT_HTTP_TIMEOUT_MS = IS_SERVERLESS_RUNTIME ? 12_000 : 45_000;
const DEFAULT_OVERPASS_MAX_RETRIES = IS_SERVERLESS_RUNTIME ? 1 : 3;
const DEFAULT_OVERPASS_RETRY_BASE_MS = IS_SERVERLESS_RUNTIME ? 250 : 800;
const DEFAULT_OVERPASS_QUERY_TIMEOUT_SECONDS = IS_SERVERLESS_RUNTIME ? 25 : 60;
const DEFAULT_OVERPASS_REQUEST_TIMEOUT_MS = IS_SERVERLESS_RUNTIME ? 7_500 : DEFAULT_HTTP_TIMEOUT_MS;
const DEFAULT_OVERPASS_TOTAL_TIMEOUT_MS = IS_SERVERLESS_RUNTIME ? 18_000 : 90_000;

export const HTTP_TIMEOUT_MS = toPositiveInt(process.env.HTTP_TIMEOUT_MS, DEFAULT_HTTP_TIMEOUT_MS);
export const OVERPASS_MAX_RETRIES = toPositiveInt(process.env.OVERPASS_MAX_RETRIES, DEFAULT_OVERPASS_MAX_RETRIES);
export const OVERPASS_RETRY_BASE_MS = toPositiveInt(process.env.OVERPASS_RETRY_BASE_MS, DEFAULT_OVERPASS_RETRY_BASE_MS);
export const OVERPASS_QUERY_TIMEOUT_SECONDS = toPositiveInt(
  process.env.OVERPASS_QUERY_TIMEOUT_SECONDS,
  DEFAULT_OVERPASS_QUERY_TIMEOUT_SECONDS
);
export const OVERPASS_REQUEST_TIMEOUT_MS = toPositiveInt(
  process.env.OVERPASS_REQUEST_TIMEOUT_MS,
  DEFAULT_OVERPASS_REQUEST_TIMEOUT_MS
);
export const OVERPASS_TOTAL_TIMEOUT_MS = toPositiveInt(
